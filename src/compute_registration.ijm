...
if(sampleId == "lung_2_2") {
    finalDeformation = "Coarse";
}
...
registrationCommand = "source_image=" + sourceImage + " target_image=" + targetImage + " registration=Mono image_subsample_factor=0 initial_deformation=[Very Coarse] final_deformation=" + finalDeformation + " divergence_weight=0 curl_weight=0 landmark_weight=0 image_weight=1 consistency_weight=10 stop_threshold=0.01 verbose save_transformations save_direct_transformation=" + transFile;
